...
class UserInterface:
    ...
    def __init__(self):
        ...
        button_change_tributation_for_ncm = ctk.CTkButton(
            buttons_frame, text="Alterar a tributação de Itens por NCM",
            command=lambda: self.open_modal("Digite os NCM's e o ID da Tributação",
                                            self.run_change_tributation_for_ncm,
                                            operation_type="run_change_tributation_for_ncm",
                                            show_second_entry=True),
        ...
        button_change_tributation_for_ncm.grid(row=0, column=0, ipadx=10, ipady=10, pady=10, padx=10)

        button_reg_digisat_clean = ctk.CTkButton(
            buttons_frame, text="Elimina os registro do Digisat do Windows",
            command=self.reg_digisat_clean.run_thread_reg_digisat_clean, fg_color='#f6882d', hover_color='#c86e24',
            text_color='white',
            border_color='#123f8c',
            font=('arial', 15, 'bold'),
        ...
        button_reg_digisat_clean.grid(row=0, column=1,ipadx=10, ipady=10, pady=10, padx=10)

        button_inactive_products = ctk.CTkButton(
            buttons_frame, text="Inativar produtos Zerados ou Negativos",
            command=self.inactive_products.run_thread_inactive_products, fg_color='#f6882d', hover_color='#c86e24',
            text_color='white',
            border_color='#123f8c',
            font=('arial', 15, 'bold'),
        ...
        button_inactive_products.grid(row=1, column=0,ipadx=10, ipady=10, pady=10, padx=10)

        button_movimentations_clean = ctk.CTkButton(
            buttons_frame, text="Limpa movimentações da Base",
            command=self.movimentations_clean.run_thread_movimentations_clean, fg_color='#f6882d',
            hover_color='#c86e24',
            text_color='white',
            border_color='#123f8c',
        ...
        button_movimentations_clean.grid(row=1, column=1, ipadx=10, ipady=10, pady=10, padx=10)

        button_mei_able = ctk.CTkButton(
            buttons_frame, text="Permitir o ajuste de Estoque",
            command=self.mei_able.run_thread_mei_able, fg_color='#f6882d', hover_color='#c86e24',
            text_color='white',
            border_color='#123f8c',
            font = ('arial', 15, 'bold'),
        ...
        button_mei_able.grid(row=2, column=0, ipadx=10, ipady=10, pady=10, padx=10)

        button_base_create = ctk.CTkButton(
            buttons_frame, text="Criar base nova zerada!",
            command=self.base_create.run_thread_base_creator, fg_color='#f6882d', hover_color='#c86e24',
            text_color='white',
            border_color='#123f8c',
            font=('arial', 15, 'bold'),
        ...
        button_base_create.grid(row=2, column=1, ipadx=10, ipady=10, pady=10, padx=10)

        button_find_ids = ctk.CTkButton(
            buttons_frame, text="Localiza ID's no banco",
            command=lambda: self.open_modal("Digite o ID a buscar", self.run_find_ids,
                                            operation_type="run_find_ids",
                                            show_second_entry=False),
            fg_color='#f6882d',
        ...
        button_find_ids.grid(row=3, column=0, ipadx=10, ipady=10, pady=10, padx=10)

        button_base_clean = ctk.CTkButton(
            buttons_frame, text="Zera a base atual",
            command=self.base_clean.run_thread_base_clean, fg_color='#f6882d', hover_color='#c86e24',
            text_color='white',
            border_color='#123f8c',
            font=('arial', 15, 'bold'),
        ...
        button_base_clean.grid(row=3, column=1, ipadx=10, ipady=10, pady=10, padx=10)
        ...
        cancel_button.grid(row=2, column=0, ipadx=10, ipady=10, pady=10, padx=10)
